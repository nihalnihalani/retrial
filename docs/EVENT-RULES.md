# OFFICIAL Event Rules — Daytona HackSprint w/ Braintrust (from Notion, fetched 2026-07-23)

## Format — ONE DAY, TWO ROUNDS
- **Friday, July 24, 2026** at the **WorkOS office, 660 Market St, SF**. Bring physical ID. Wifi: WorkOS / theft8-clump5.
- Hacking **10:00 AM – 3:30 PM (~5.5h)**. Submit by **3:30 PM sharp** via Devpost.
- **Round 1 (async, Devpost):** all submissions judged → **only 8 teams advance.**
- **Round 2 (live):** top 8 pitch on stage — **3 min pitch + 2 min Q&A.** Then top-3 chosen.
- **Best Use Awards judged SEPARATELY by each partner — open to ALL teams, not just the 8 finalists.**
- "Detailed judging guidelines shared Tuesday" — more rules may come.

## ⭐ OFFICIAL JUDGING CRITERIA (equal-weighted — THIS OVERRIDES our old judge-archetype strategy)
- **Impact Potential 25%** — real problem? significant impact on users/industries?
- **Technical Execution 25%** — how well built?
- **Creativity 25%** — how original/innovative?
- **Presentation 25%** — how effectively communicated & demonstrated?
- **Sponsor Tool Usage = BONUS only** — meaningful, goal-aligned integration.

## Devpost submission (round-1 deliverables — must nail these to reach top 8)
- Unique team name; members w/ emails+socials.
- **Demo video < 2 min** (screen recording, "highly recommended").
- Description: 2-3 sentence summary; the problem + its impact; key technical architecture; list of sponsor tools + how integrated.
...
5. **Presentation 25% + 3min+2min Q&A live** — rehearse the pitch AND the Q&A; the demo video and live demo are half the rubric between them.
