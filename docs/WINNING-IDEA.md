...
7. **Impact ammo (cite in video + pitch, attribute softly as "Google/Microsoft published research"):** Google: ~16% of tests exhibit flakiness; flaky = 4.56% of test failures; ~3.7 engineering hours to investigate ONE flaky test; 1-in-7 suite runs hit a flaky failure. Microsoft: ~25% of CI test failures are flaky; ~30 min per investigation. Industry: 15-30% of CI time burned on reruns; ~$400k/yr for a 50-eng team. [via StickyMinds/TestDino/Autonoma aggregations]
