...
// The screenshot moment: the SAME test passing on one rerun and failing on
  ...
  return (
    <div className="split-screen">
      <div className="split-cell split-pass">
        ...
        <div className="split-meta mono">rerun #{pass.index}</div>
      </div>
      ...
      <div className="split-cell split-fail">
        ...
        <div className="split-meta mono">rerun #{fail.index}</div>
      </div>
    </div>
  );
}
